...
def compute_frame_pos_weight(dataset: LocalizedDurationDataset, label_vocab):
...
def main():
    ...
    full_ds = LocalizedDurationDataset(
        manifest_path,
    ...
    train_ds = LocalizedDurationDataset(
        manifest_path,
        indices=train_idx,
    ...
    val_ds = LocalizedDurationDataset(
        manifest_path,
        indices=val_idx,
        label_vocab=label_vocab,
        sample_rate=args.sample_rate,
    ...
    train_loader = DataLoader(train_ds, batch_size=args.batch_size, shuffle=True, num_workers=0, collate_fn=collate_localized_duration_batch)
    val_loader = DataLoader(val_ds, batch_size=args.batch_size, shuffle=False, num_workers=0, collate_fn=collate_localized_duration_batch)
