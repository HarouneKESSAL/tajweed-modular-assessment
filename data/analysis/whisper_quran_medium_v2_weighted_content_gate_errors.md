...
|---|---:|
| samples | 407 |
| exact_after_rate | 0.7297 |
| avg_char_accuracy_after | 0.9744 |
| cer_after | 0.0198 |
| avg_gold_len | 27.7617 |
| avg_pred_len | 27.6757 |
| num_errors_after_muqattaat | 110 |
| num_near_misses_ge_095 | 57 |
| num_strong_near_misses_ge_098 | 5 |
| num_muqattaat_changed | 4 |
...
| long_predictions_len_delta_ge_2 | 9 |
| muqattaat_remaining_errors | 4 |

## By length

| bucket | samples | exact_after | char_acc | CER | avg_gold_len |
|---|---:|---:|---:|---:|---:|
| 001_010 | 15 | 0.733 | 0.800 | 0.135 | 4.93 |
...
| saood_ash_shuraym | 13 | 0.692 | 0.933 | 0.022 |
...
| abdul_basit_murattal | 46 | 0.761 | 0.967 | 0.013 |
| ali_jaber | 20 | 0.800 | 0.930 | 0.013 |
...
- top inserted pred chars: `[('ا', 23), ('ي', 17), ('و', 17), ('ن', 9), ('ل', 8), ('م', 7), ('غ', 6), ('ب', 6), ('ف', 6), ('د', 4), ('ذ', 4), ('ك', 3), ('ر', 3), ('ع', 3), ('ه', 3), ('س', 2), ('ق', 2), ('ظ', 2), ('ث', 1), ('ئ', 1), ('ء', 1), ('ط', 1), ('ص', 1)]`
